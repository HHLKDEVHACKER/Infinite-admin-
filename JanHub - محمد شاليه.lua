...
function Lib:Win(Name,key)
	...
	Tabs.Size = UDim2.new(0, 115, 0, 205)
	...
	Pages.Position = UDim2.new(0.302272737, 0, 0.163333327, 0)
	Pages.Size = UDim2.new(0, 296, 0, 205)
	...
	function Pagsee:Tab(name,vis)
		...
		Page.Size = UDim2.new(0, 296, 0, 205)
		...
		PageScrolling.Size = UDim2.new(0, 296, 0, 205)
...
local Win = Lib:Win("Nokie Hub | ماب البيوت العربي")
local Home = Win:Tab("الرئيسية",true)
local Game = Win:Tab("القيم")
local Misc = Win:Tab("اخرى")
...
Game:Toggle("فلينق الكل",function(x)
	getgenv().FlingAll = x
	...
	while getgenv().FlingAll == true do
		wait()
		local random = game:GetService("Players"):GetPlayers()[math.random(1, #game:GetService("Players"):GetPlayers())]
...
Misc:Toggle("Anti Sit",function(x)
	if x == true then
...
Misc:Toggle("Anti AFK",function(x)
    getgenv().AntiAfk = x
    spawn(function()
...
Misc:Toggle("الليل / النهار",function(x)
	if x == true then
...
Misc:Button("التجسس على محادثات الخاص",function()
...
Misc:Button("Nameless Admin",function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NamelessAdmin/main/Source'))()
end)

Misc:Button("اعادة دخول للسيرفر",function()
	game:GetService("TeleportService"):Teleport(game.PlaceId)
end)

Misc:Button("دخول سيرفر اخر",function()
	local AllIDs = {}
	local foundAnything = ""
...
Animations:Button("Astronaut",function()
...
other:ImageLabel("https://www.roblox.com/headshot-thumbnail/image?userId=1259903042&width=420&height=420&format=png","Banda Mod","Famous / Showcaser")
other:ImageLabel("https://www.roblox.com/headshot-thumbnail/image?userId=2591604705&width=420&height=420&format=png","Mohamed","YouTuber/Mohamed")
